...
products = [
    {
        ...
        'description': 'An smart earphone where intelligence has been built into its system.',
        'price': 5,
    ...
    },
    {
        'id': 2,
        'title': 'Suction cup',
        'description': 'Highly reliable and quality suction cup for household uses',
        'price': 10,
        'category': 'Household options',
        'image': 'suctioncup.jpg'
    },
    {
        'id': 3,
        'title': 'Heart Beat sensor wearable device',
        'description': 'An embedded device that monitors the heart beat of its user in real-time.',
        'price': 15,
        'category': 'Electronics',
        'image': 'Health & Medicine.jpg'
    },
    {
        'id': 4,
        'title': 'Yoga Mat',
        'description': 'Yoga mats are essential tools for practicing yoga, providing a stable and comfortable surface for various poses and exercises',
        'price': 15,
        'category': 'Sport and Fitness Equipment',
        'image': 'YogaMat.jpg'
    },
    {
        'id': 3,
        'title': 'Wedding Dress',
        'description': 'Wedding dresses are a central part of many wedding traditions and come in a wide variety of styles, materials, and designs',
        'price': 15,
        'category': 'Gift & Sports',
        'image': 'weddingdress.jpg'
    },
    {
        'id': 3,
        'title': 'Ginger',
        'description': 'Ginger is a valuable agricultural crop known for its aromatic rhizomes, which are used both as a spice and for medicinal purposes.',
        'price': 15,
